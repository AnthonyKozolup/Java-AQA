...
// 4. Сделать метод getWeight(), который высчитывает вес коробки, зная вес одного фрукта и их количество: вес
...
// в compare() в качестве параметра. true – если их массы равны, false в противоположном случае.
...
public class FillBoxes {
    public static void main(String[] args){
        ...
        appleBoxes.createBox(new Apple());
        appleBoxes.addFruit(new Apple());
        System.out.println("APPLES:");
        System.out.println("Box of Apples weights: " + appleBoxes.getBoxWeight() + " kg");
        System.out.println("");
        System.out.println("ORANGES:");
        Boxes<Orange>orangeBoxes=new Boxes<>();
        orangeBoxes.createBox(new Orange());
        orangeBoxes.addFruit(new Orange());
        System.out.println("Box of Oranges weights: " + orangeBoxes.getBoxWeight() + " kg");
        System.out.println("");

        System.out.println("Box of Apple is equal box of Orange - " + appleBoxes.compareBox(orangeBoxes));
